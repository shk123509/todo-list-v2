...
//             {/* Left Side - Input Form */}
//             <div className="input-section">
//               {/* property form goes here (unchanged) */}
...
import React, { useState } from "react";
import "./HousingPricePredictor.css"; // Import the CSS file
...
const HousingPricePredictor = () => {
  ...
  const predictPrice = () => {
    ...
    setTimeout(() => {
      const basePrice = formData.area * 7500;
      const bedroomValue = formData.bedrooms * 500000;
      const bathroomValue = formData.bathrooms * 300000;
      const parkingValue = formData.parking * 200000;
      const furnishingValue =
        formData.furnished === "Fully-Furnished"
          ? 1000000
          : formData.furnished === "Semi-Furnished"
          ? 500000
          : 0;
      ...
      const finalPrediction =
        totalPrice + Math.floor(Math.random() * 500000);

      setPrediction(finalPrediction);
      setConfidence(Math.floor(Math.random() * 21) + 80);
  ...
  return (
    <div className="housing-predictor-container">
      ...
      <div className="content-wrapper">
        <h1 className="app-title">🏡 Housing Price Predictor</h1>
        <p className="subtitle">
          Enter property details to estimate the market value
        </p>
                  ...
                  <div className="price-range">
                    <div className="range-item">
                      ...
                      <span className="range-value">
                        {formatPrice(prediction * 0.9)}
                      </span>
                    </div>
                    <div className="range-item">
                      <span className="range-label">Max Estimate</span>
                      <span className="range-value">
                        {formatPrice(prediction * 1.1)}
                      </span>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="history-list">
                      {priceHistory.map((item, idx) => (
                        <div key={idx} className="history-item">
                          ...
                          <span className="history-specs">
                            {item.specs.location} • {item.specs.area} sq ft •{" "}
